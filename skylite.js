  ...
  window.Skylite = (function() {
    function Skylite(options) {
      ...
      if (this.actions != null) {
        $.each(this.actions, (function(_this) {
        ...
        $("<button>").text('Okay').addClass('ok').click((function(_this) {
          return function() {
            return _this.dismiss();
          };
        })(this)).appendTo(this.$actions);
      }
    ...
    Skylite.prototype.mask = function() {
      ...
      return this.$mask.click((function(_this) {
        return function() {
          if (!_this.lockMask) {
            return _this.dismiss();
          }
